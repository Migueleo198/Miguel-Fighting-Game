...
window.addEventListener('keyup', (event) => {
    switch (event.key) {
        ...
        case 'ArrowLeft':
            ...
            if (!keyArrowDownRight) sprites.enemy.velocity.x = 0;
            sprites.enemy.switchSprite('idle');
            break;
        case 'ArrowRight':
            keyArrowDownRight = false;
            if (!keyArrowDownLeft) sprites.enemy.velocity.x = 0;
            sprites.enemy.switchSprite('idle');
            break;
